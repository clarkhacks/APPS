...
function action() {
    ...
    for (var i = 0; i < quote.length; i++) {
        ...
        while (document.getElementById("meme").src == quote[q] || count[q] > min) {
            var q = Math.floor(Math.random() * (quote.length));
        }
        count[q]++;
        var memeSrc = Math.floor(Math.random() * 6) + 1;
        var memeLink = "https://memegen.link/custom/-/" + quote[q] + ".jpg?alt=https://apps.clarkhacks.com/bob_ross/meme/m" + memeSrc + ".jpg";
        document.getElementById("meme").src = memeLink;
        document.getElementById("aMeme").href = memeLink;
        // random color
        var colors = ['#2a96ea', '#2482cc', '#4396d8', '#4ba1e5', '#449ee5'];
